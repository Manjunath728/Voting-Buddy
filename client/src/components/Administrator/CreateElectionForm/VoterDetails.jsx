    ...
    <>
      {
        (FormData.securityType === "Public") ?
          ...
          <TextField
                          ...
                          onChange={(event)=>setFormData({...FormData,maxVoter:event.target.value,price:event.target.value*10})}
                          margin='normal'
                          name='maxVoter'
                  ...
                  if (files) {
                    ...
                    Papa.parse(files[0], {
                      ...
                      complete: ({ data }) => {
                        ...
                        const newData = [...new Map(data.map(item => [item["email"], item])).values()]
                        
                        if (newData[0].hasOwnProperty("uniqueKey")&& data[0].hasOwnProperty("email")) {
                        ...
                        if(duplicateIds.length!==0){
                          toast.error(`${duplicateIds.length} duplicate email found and removed `, {
                          ...
                          toast.error(`Csv File Not matching , please select valid file or download and edit sample file `, {
                            position: "bottom-center",
                            autoClose: 10000,
                            hideProgressBar: false,
                            closeOnClick: true,
